...
VALUES 
  ...
  (206, 'Partial Content', 'La respuesta solo contiene una parte del recurso solicitado', '/images/cat_206.jpeg'),
  (207, 'Multi-Status', 'La respuesta contiene múltiples códigos de estado para diferentes partes de la solicitud', '/images/cat_207.jpeg'),
  (300, 'Multiple Choices', 'Hay múltiples opciones disponibles', '/images/cat_300.jpeg'),
  (301, 'Moved Permanently', 'El recurso se ha movido permanentemente a una nueva ubicación', '/images/cat_301.jpeg'),
  (302, 'Found', 'El recurso se ha encontrado temporalmente en una nueva ubicación', '/images/cat_302.jpeg'),
  (303, 'See Other', 'Se debe realizar una solicitud adicional a una ubicación diferente', '/images/cat_303.jpeg'),
  (304, 'Not Modified', 'El recurso no ha sido modificado desde la última vez que se accedió a él', '/images/cat_304.jpeg'),
  (305, 'Use Proxy', 'Se debe utilizar un proxy para acceder al recurso', '/images/cat_305.jpeg'),
  (307, 'Temporary Redirect', 'El recurso se ha redirigido temporalmente a una nueva ubicación', '/images/cat_307.jpeg'),
  (308, 'Permanent Redirect', 'El recurso se ha redirigido permanentemente a una nueva ubicación', '/images/cat_308.jpeg'),
  ...
  (506, 'Variant Also Negotiates', 'El servidor debe negociar con el cliente después de realizar una negociación de contenido', '/images/cat_506.jpeg'),
  (507, 'Insufficient Storage', 'El servidor no puede almacenar la representación necesaria para completar la solicitud', '/images/cat_507.jpeg'),
  (508, 'Loop Detected', 'Se detectó un ciclo en la solicitud', '/images/cat_508.jpeg'),
  (509, 'Bandwidth Limit Exceeded', 'Se ha excedido el límite de ancho de banda del servidor', '/images/cat_509.jpeg'),
  (418, 'I am a teapot', '¿No es divertido?', '/images/cat_418.jpeg');